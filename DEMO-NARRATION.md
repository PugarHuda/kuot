...
**SAY:** "Every run is settled on-chain. Here are real attestations on Arc — over sixty queries, five
hundred author payouts already, in real USDC. Each settlement also commits a tamper-evident digest of the
