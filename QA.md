...
| Playwright (E2E browser click-through, `npm run e2e`) | **22 / 22 pass** (12-page smoke + cited ORCID lookup + funding-model toggle + Cite-button + optional-budget guard + sidebar/nav clicks) |
| `tsc --noEmit` | clean |
| `next build` | compiles |
