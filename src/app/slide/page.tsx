...
const NARRATION: Record<string, string> = {
  ...
  proof:
    "And it's all real. No mocks in the critical path. Eleven contracts live on Arc, a hundred and sixty-eight tests green, real U.S.D.C. flowing, and a real Circle Gateway batched settlement on chain.",
  tracks:
